...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      aria-label="Chat with Magency.in on WhatsApp"
      className={`fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-whatsapp text-whatsapp-foreground shadow-lg transition-all duration-300 hover:scale-110 ${
